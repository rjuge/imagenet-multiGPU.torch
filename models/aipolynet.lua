...
if  nInputPlane ~= nOutputPlane  then
      res:add(nn.Padding(1, nOutputPlane-nInputPlane, 3))
end
...
block1:add(residual_block(32, 32, 3, 3, 2, 2, 1, 1))
block1:add(residual_block(32, 32, 3, 3, 2, 2, 1, 1))

-- second block
local block2 = nn.Sequential()
block2:add(residualWithConv_block(32, 32, 3, 3, 2, 2, 1, 1))
block2:add(residual_block(32, 32, 3, 3, 2, 2, 1, 1))
block2:add(residual_block(32, 32, 3, 3, 2, 2, 1, 1))
block2:add(residual_block(32, 32, 3, 3, 2, 2, 1, 1))
...
block3:add(residual_block(64, 64, 3, 3, 2, 2, 1, 1))
block3:add(residual_block(64, 64, 3, 3, 2, 2, 1, 1))
block3:add(residual_block(64, 64, 3, 3, 2, 2, 1, 1))
block3:add(residual_block(64, 64, 3, 3, 2, 2, 1, 1))
block3:add(residual_block(64, 64, 3, 3, 2, 2, 1, 1))
...
block4:add(residual_block(128, 128, 3, 3, 2, 2, 1, 1))
block4:add(residual_block(128, 128, 3, 3, 2, 2, 1, 1))
