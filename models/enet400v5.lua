...
model:add(bottleneck(64, 128, true)) -- size of 28x28
-- pass 1:
...
model:add(wbottleneck(128, 128))
model:add(xxxdbottleneck(128, 256))
model:add(bottleneck(256, 256, true)) -- size of 14x14

--pass 2:
model:add(cbottleneck(256, 256))
model:add(dbottleneck(256, 256))
model:add(wbottleneck(256, 256))
model:add(xdbottleneck(256, 256))
model:add(cbottleneck(256, 256))
model:add(xxdbottleneck(256, 256))
model:add(wbottleneck(256, 256))
model:add(xxxdbottleneck(256, 512))
model:add(bottleneck(512, 512, true))
